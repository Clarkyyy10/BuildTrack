...
import { Button, Card, EmptyState, ErrorState, ListSkeleton } from '../components/ui.js';
    ...
    <div>
      ...
      <div className="stack" style={{ gap: 10 }}>
        {data?.notifications.map((n, i) => (
          <Card
            key={n.id}
            className="bt-stagger"
            style={{
              ['--i' as string]: i,
              background: n.isRead ? undefined : 'var(--accent-soft)',
              borderColor: n.isRead ? undefined : 'var(--accent-border)',
            } as CSSProperties}
          >
            <div className="row-between">
              <div className="row" style={{ gap: 10, alignItems: 'flex-start' }}>
                {!n.isRead && <span aria-hidden title="Unread" style={{ width: 7, height: 7, borderRadius: '50%', background: 'var(--accent)', flexShrink: 0, marginTop: 6 }} />}
                <div>
